; (function (window, $) {
    ...
    var toast = function (config) {
        ...
        var toast = $([
            ...
            '<p style="margin-bottom:0px;">' + config.message + '</p>',
...
function toastMeaasage(type, message) {
    if (type == "error" || type == "warning") {
        message = '<i class="fa fa-warning" style="font-size:20px"></i>&nbsp;' + message
    }
    else if (type == 'info') {
        
        message = '<i class="fa fa-info-circle" style="font-size:20px"></i>&nbsp;' + message
    }
    else if (type == 'success') {

        message = '<i class="fa fa-check" style="font-size:20px"></i>&nbsp;' + message
    }
